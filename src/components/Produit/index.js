...
//     const MSG_DELETE_SUCCESS = "La Produit a été supprimée avec succès";
//     const MSG_ADD_SUCCESS = "La Produit a été ajoutée avec succès";
...
//     useEffect(() => {
//         setLoading(true);
//         axios.get("produit/list").then((res) => {
...
//                         {/* <NavLink to={"importer"}>
//             {" "}
//             <button className="app-content-headerButton">Importer Produits</button>
...
//                             <NavLink to={"importer"}>
//                                 {" "}
//                                 <button className="m-2 app-content-headerButton">Importer Produits</button>

//                             </NavLink>

//                             <NavLink to={"new"}>
//                                 <button className="app-content-headerButton">Ajouter Produits</button>
//                             </NavLink>
//                         </div>
//                     }
//                 </div>
...
//                                         </div>
//                                         <div className="product-cell category">
//                                             <span className="cell-label">Nom hh :</span>
//                                             {wilaya.nom}
//                                         </div>
